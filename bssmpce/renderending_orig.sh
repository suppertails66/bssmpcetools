...
function outlineSolidPixels() {
  convert "$1" \( +clone -channel A -morphology EdgeOut Diamond:1 -negate -threshold 15% -negate +channel +level-colors \#111111 \) -compose DstOver -composite "$2"
}
...
function renderStringAlt() {
  ...
  convert -background none -font $fontname -density 72 -pointsize 13 -fill white -gravity North -size 248x caption:"$text" $file
...
renderString rsrc/ending/s28_0_1b "As they gaze into each other's eyes, Gurio and Naru― "
renderString rsrc/ending/s29_0_0 "Cut it out, Usagi! What's THAT supposed to be?!"
#renderString rsrc/ending/s29_0_1 ""
renderString rsrc/ending/s29_0_1a "I told you, there's nothing between me and Umino!"
renderString rsrc/ending/s29_0_1b "I told you, there's nothing between me and Gurio!"
...
renderString rsrc/ending/s36_0b "What matters is that Naru and Gurio are getting along well now."
#renderString rsrc/ending/s36_1 ""
